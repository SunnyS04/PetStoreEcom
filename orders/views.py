...
def send_order_email(order,cart_items):
    ...
    email_body = "Thank You for Placing the Order,Please find the attached invoice for your referance."
    ...
    if request.method == "POST":
        try:
            ...
            for item in cart_item:
                ...
                orderpet.save()
            send_order_email(order_data,cart_item) # calling the send_order_email function    
            cart_item.delete()   # removing cart data.
